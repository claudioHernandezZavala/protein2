    ...
    <div className="bg-[#0a0a0a] text-[#f0f0f0] min-h-screen font-sans selection:bg-[#2dd4bf] selection:text-black overflow-x-hidden relative">
      ...
      <header className="relative w-full h-screen flex flex-col justify-center items-center text-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <p className="font-sans-grotesk text-gray-300 max-w-xl mx-auto text-lg md:text-xl leading-relaxed mb-10">
            Premium protein shakes, guilt-free waffles, and energy teas designed
        ...
        <a
          ...
          className="absolute bottom-10 animate-bounce text-white/50 hover:text-white transition-colors"
      ...
      <div className="w-full bg-[#2dd4bf] py-4 overflow-hidden transform -skew-y-2 border-y-4 border-black">
        <div className="whitespace-nowrap flex animate-marquee">
          {[...Array(6)].map((_, i) => (
            <span
              key={i}
              className="text-black font-serif-display font-bold italic text-4xl md:text-6xl mx-8"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <RevealElement>
            ...
            <p className="font-sans-grotesk text-gray-400 text-lg leading-relaxed mb-6">
              Located at 7615 18th Ave, we are redefining the protein
              experience. Gone are the days of chalky shakes. We blend gourmet
              flavors with high-quality protein to create treats that feel like
              cheating but fuel like champions.
            </p>
            <div className="flex gap-8 mt-8">
              <div className="flex flex-col">
                <span className="text-3xl font-serif-display text-white">
                  25g+
                </span>
                <span className="text-sm font-sans-grotesk text-gray-500 uppercase">
                  Protein per shake
                </span>
              </div>
              <div className="flex flex-col">
      ...
      <section className="py-20 overflow-hidden bg-white/5">
        <div className="mb-12 text-center">
          <span className="font-sans-grotesk text-[#2dd4bf] uppercase tracking-widest text-sm">
            Visuals
          </span>
          <h3 className="font-serif-display text-4xl text-white mt-2">
            The Vibe
          </h3>
        </div>
        ...
        <div className="flex space-x-6 w-[200%] animate-marquee hover:[animation-play-state:paused]">
          {[
            ...
            <div
              key={i}
              className="flex-shrink-0 w-[300px] h-[400px] overflow-hidden relative group"
            >
              <img
                src={src}
      ...
      <section
        id="menu"
        className="py-32 px-6 max-w-7xl mx-auto relative min-h-screen"
      >
        ...
        <div className="text-center mb-16">
          <h2 className="font-serif-display text-6xl md:text-8xl mb-4">
            The Menu
          </h2>
          <p className="font-sans-grotesk text-xl text-gray-400">
            High Protein. Low Guilt. Insane Flavor.
          </p>
        </div>
      ...
      <section
        id="location"
        className="relative py-32 bg-white text-black clip-image-slant"
      >
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[600px] w-full bg-gray-200 overflow-hidden group">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-[#2dd4bf] rounded-full flex items-center justify-center mix-blend-multiply opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              <span className="font-serif-display italic font-bold text-xl text-black">
                Brooklyn
              </span>
            </div>
          </div>
      ...
      <footer className="bg-black pt-32 pb-10 px-6 border-t border-white/10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-end">
          <div className="mb-12 md:mb-0">
            <h2 className="font-serif-display text-4xl md:text-6xl italic mb-6">
              Protein
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#2dd4bf] to-[#f472b6]">
                Dreams
              </span>
            </h2>
            <div className="font-sans-grotesk text-gray-500 max-w-sm space-y-2">
              ...
              <p className="text-white hover:text-[#2dd4bf] cursor-pointer transition-colors">
                347-653-1665
              </p>
            </div>
          </div>
  ...
  >
    ...
    <div className="h-[65%] w-full overflow-hidden relative">
      ...
      <div className="absolute top-4 right-4 z-20 bg-black/70 backdrop-blur-md px-3 py-1 border border-white/20 rounded-full">
        <span className="font-sans-grotesk font-bold text-[#2dd4bf]">
          {item.price}
        </span>
      </div>
    </div>
    ...
    <div className="flex-1 p-6 relative flex flex-col justify-between bg-black/40 backdrop-blur-md border-t border-white/5">
      ...
      <div>
        <div className="flex justify-between items-center mb-2">
          <h3 className="font-serif-display text-2xl group-hover:text-[#2dd4bf] transition-colors">
            {item.title}
          </h3>
          {item.iconType === "Zap" && (
          ...
          {item.iconType === "Cookie" && (
            <Cookie size={16} className="text-[#f472b6]" />
          )}
        </div>
        <p className="font-sans-grotesk text-sm text-gray-400 line-clamp-2">
          {item.desc}
        </p>
      </div>
